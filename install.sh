...
install() {
	...
	cp -r "$SRC_DIR/gnome-shell/assets"							"$SHELL_THEME_DIR/gnome-shell"
	cp -r "$SRC_DIR/gnome-shell/pad-osd.css"					"$SHELL_THEME_DIR/gnome-shell"
	cp -r "$SRC_DIR/gnome-shell/gnome-shell.css"				"$SHELL_THEME_DIR/gnome-shell"
